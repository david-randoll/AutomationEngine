...
public final class AutomationTraceExtractor {
    ...
    /**
     * Get the hierarchical execution tree from AutomationResult.
     * This is the recommended method for UI rendering as it provides a recursive
     * structure.
     *
     * @param result The automation result
     * @return Execution tree map, or null if not present
     */
    @SuppressWarnings("unchecked")
    public static Map<String, Object> getExecutionTree(AutomationResult result) {
        Map<String, Object> trace = extractTrace(result);
        Object tree = trace.get(TraceConstants.EXECUTION_TREE);
    ...
    /**
     * Check if the automation was executed (triggers activated and conditions
     * satisfied).
     *
     * @param result The automation result
     * @return true if executed, false if skipped
     */
    public static boolean wasExecuted(AutomationResult result) {
        Map<String, Object> trace = extractTrace(result);
        Object executed = trace.get("executed");
    ...
    /**
     * Get the automation alias from trace data.
     *
     * @param result The automation result
     * @return Automation alias, or null if not present
     */
    public static String getAutomationAlias(AutomationResult result) {
        Map<String, Object> trace = extractTrace(result);
        Object alias = trace.get("automationAlias");
