...
@JsonPropertyOrder({
        ...
        CurrentUserHasRoleConditionContext.Fields.requireAllRoles
})
public class CurrentUserHasRoleConditionContext implements IConditionContext {
    private String alias;
    private String description;
    private List<String> requiredRoles;
    private boolean requireAllRoles = false; // If true, user must have ALL roles; if false, user must have ANY role
}