...
const DefinitionCard = ({ name, definition, blockType, onUnregister }: DefinitionCardProps) => {
    ...
    const handleEdit = () => {
        navigate({ to: "/user-defined/$blockType/edit", params: { blockType }, search: { name } });
    };
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <Card className="py-4">
                    <CardContent className="p-0 px-4">
                        <Tabs value={activeTab} onValueChange={(v) => navigate({ to: "/user-defined/$blockType", params: { blockType: v } })}>
                                ...
                                <TabsContent key={config.type} value={config.type} className="mt-4">
                                    <div className="space-y-4">
                                        <div className="flex items-center justify-between">
                                            ...
                                            <Button size="sm" onClick={() => navigate({ to: "/user-defined/$blockType/new", params: { blockType: config.type } })}>
