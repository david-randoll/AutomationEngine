                    ...
                    <div className="flex items-center gap-4 h-14">
                        ...
                        <div className="flex gap-2">
                            <button
                                ...
                                className={`px-3 py-1.5 text-sm rounded-md transition-colors ${currentPage === 'builder'
                            ...
                            <button
                                ...
                                className={`px-3 py-1.5 text-sm rounded-md transition-colors ${currentPage === 'user-defined'
                                    ? 'bg-primary text-primary-foreground'
                                    : 'text-gray-600 hover:bg-gray-100'
                                    }`}
                            >
